...
MINERALS: list[dict] = [
    ...
    # 3. Cobalt
    {
        ...
        "mines": [
            ...
            {"name": "Kisanfu (KFM)", "owner": "CMOC 71.25% / CATL 23.75% / DRC govt 5%", "country": "DRC", "lat": -10.4, "lon": 25.7, "production_t": 15000, "note": "World's largest undeveloped cobalt deposit at time of acquisition",
             "risks": [
